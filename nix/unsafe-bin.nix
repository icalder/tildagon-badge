  ...
  in
    pkgs.stdenv.mkDerivation {
      ...
      src = pkgs.fetchzip {
        ...
        hash =
          {
            x86_64-linux = "sha256-837shgsDonrmUqZsIhUoR+93IR8tUat67PiHfShilJc=";
        ...
        pkgs.stdenv.mkDerivation {
          ...
          src = pkgs.fetchzip {
            ...
            hash =
              {
                x86_64-linux = {
                  xtensa = "sha256-f2zKqpgdYqKRwvgFsPGrG4jiborzjam5aOPGqso0Lqg=";
                  riscv32 = "sha256-Jy3DScJ9UiEJcPLVqfV5fVgg9uAmk9OZKZDEq1aPSFk=";
                };
                aarch64-linux = {
